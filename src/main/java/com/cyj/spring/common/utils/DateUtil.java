...
public class DateUtil {
     ...
     * @return
     */
    public static List<String> findmonthDates(String dBegin, String dEnd) throws ParseException {
        List<String> lDate = new ArrayList<String>();
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM");
        Calendar dd = Calendar.getInstance();//定义日期实例
        dd.setTime(sdf.parse(dBegin));//设置日期起始时间
        while (sdf.parse(dEnd).after(dd.getTime())) {//判断是否到结束日期
...
//		Date date = randomDate("2018-06-01","2018-08-01");
//		System.out.println(new SimpleDateFormat("yyyy-MM-dd").format(date));
    ...
    public static List<String> findDates(String dBegin, String dEnd) {
        List<String> lDate = new ArrayList<String>();
        Date begin = parseDate(dBegin, "yyyy-MM-dd");
        Date end = parseDate(dEnd, "yyyy-MM-dd");
        lDate.add(dBegin);
    ...
    public static void main(String[] args) {
        ...
        System.out.println(formatDate(getAppointDate(parseDate(getCurrentDate(), "yyyy-MM-dd"), -30), "yyyy-MM-dd"));
    }
}
